...
const RenderedService = lazy(() => import('./pages/admin/RenderedService.tsx'))
  ...
  },
  {
    ...
    children: [
      { path: "/admin", element: <AdminLayout />,
        children: [
          { path: "queue/dashboard", element: <Dashboard /> },
          ...
          { path: "queue/service/rendered", element: <RenderedService /> },
