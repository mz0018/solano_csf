...
export const ViewFeedbackModal = ({ feedbackModalOpen, setFeedbackModalOpen, selectedFeedback }: ViewFeedbackModalProps) => {
        ...
        >
            <div className="space-y-4">
                {isLoading ? (
                    ...
                    <ErrorText message="Failed to load feedback." />
                ) : data ? (
                    <>
                        <div>
