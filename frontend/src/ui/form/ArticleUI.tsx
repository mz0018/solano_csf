  ...
  return (
    <article
      ...
      className={`w-full max-w-3xl shrink-0 rounded-lg border border-[var(--theme-border)] bg-[var(--theme-nav-bg)]/90 shadow-xl
        ...
        ${className}`}
    >
      <h1 className="mb-5 text-2xl font-bold text-[var(--theme-text)] sm:text-3xl md:text-4xl lg:text-5xl tracking-wide">
        {title}
      </h1>

      <p className="line-clamp-2 text-[var(--theme-text)] sm:text-xs md:text-sm lg:text-base mb-5">
        {paragraph}
      </p>
